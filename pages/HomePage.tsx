  ...
  return (
    <main className="bg-slate-50/50">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center md:text-left">
            <div className="flex items-center gap-4 justify-center md:justify-start group">
                ...
                <div>
                    ...
                    <p className="text-slate-500 text-xs mt-1 leading-relaxed max-w-[200px] mx-auto md:mx-0">Zamów do 14:00, wyślemy dzisiaj.</p>
                </div>
            </div>
            <div className="flex items-center gap-4 justify-center md:justify-start group">
                ...
                <div>
                    ...
                    <p className="text-slate-500 text-xs mt-1 leading-relaxed max-w-[200px] mx-auto md:mx-0">100% oryginalne zestawy LEGO®.</p>
                </div>
            </div>
            <div className="flex items-center gap-4 justify-center md:justify-start group">
                ...
                <div>
                    ...
                    <p className="text-slate-500 text-xs mt-1 leading-relaxed max-w-[200px] mx-auto md:mx-0">Bezproblemowy zwrot towaru.</p>
                </div>
            </div>
        </div>
      </div>
      ...
      <section className="py-12 md:py-16 max-w-7xl mx-auto px-4 md:px-8">
        <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 md:mb-10 text-center tracking-tight">Odkryj światy LEGO®</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
             {[
                ...
                <Link key={cat.slug} to={`/produkty?category=${cat.slug}`} className="group relative aspect-square rounded-[1.5rem] md:rounded-[2rem] overflow-hidden cursor-pointer shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                    ...
                    <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 text-white">
                        <h3 className="font-black text-xl md:text-2xl uppercase tracking-wider mb-1">{cat.name}</h3>
                        <span className="text-xs md:text-sm font-bold opacity-0 -translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 flex items-center gap-2">
      ...
      <section className="py-12 bg-white border-y border-slate-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
              <div className="flex items-end justify-between mb-8">
                  ...
                  <Link to="/produkty?filter=new" className="text-slate-500 font-bold hover:text-slate-900 flex items-center gap-1 transition-colors text-sm md:text-base">
                      Wszystkie <span className="hidden sm:inline">nowości</span> <ArrowRight size={18} />
                  </Link>
              </div>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                    <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
                        ...
                        <div className="lg:w-1/3 lg:sticky lg:top-32">
                            <span className="text-blue-400 font-black uppercase tracking-widest text-xs md:text-sm mb-2 md:mb-4 block">Bestsellery</span>
                            <h2 className="text-4xl md:text-6xl font-black mb-4 md:mb-6 leading-none">
                            ...
                            <Link to="/produkty?category=star-wars">
                                <button className="bg-white text-slate-900 px-6 py-3 md:px-8 md:py-4 rounded-full font-black text-xs md:text-sm uppercase tracking-wide hover:bg-blue-400 hover:text-white transition-all shadow-lg hover:shadow-blue-500/30 flex items-center gap-2 group">
                                    Przeglądaj Serię <ArrowRight className="group-hover:translate-x-1 transition-transform" />
                                </button>
                            </Link>
                        </div>
                        {/* Products Grid Side */}
                        <div className="w-full lg:w-2/3 grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-6">
            ...
            <section className="py-12 md:py-20 bg-blue-50">
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="flex flex-col lg:flex-row-reverse gap-8 lg:gap-16 items-start">
                         {/* Description Side */}
                         <div className="w-full lg:w-1/3 lg:sticky lg:top-32 text-left lg:text-right">
                            <span className="text-blue-600 font-black uppercase tracking-widest text-xs md:text-sm mb-2 md:mb-4 block">Dla konstruktorów</span>
                            <h2 className="text-4xl md:text-6xl font-black mb-4 md:mb-6 leading-none text-slate-900">
                                Twoje Miasto <br/><span className="text-blue-600">LEGO® City</span>
                            </h2>
                            <p className="text-slate-600 text-base md:text-lg mb-6 md:mb-8 leading-relaxed ml-auto">
                            ...
                            <Link to="/produkty?category=city" className="inline-block">
                                <button className="bg-blue-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-black text-xs md:text-sm uppercase tracking-wide hover:bg-blue-700 transition-all shadow-xl shadow-blue-600/20 flex items-center gap-2 group ml-auto">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
                         ...
                         <div className="w-full lg:w-1/3 lg:sticky lg:top-32">
                            <span className="text-orange-600 font-black uppercase tracking-widest text-xs md:text-sm mb-2 md:mb-4 block">Inżynieria</span>
                            <h2 className="text-4xl md:text-6xl font-black mb-4 md:mb-6 leading-none text-slate-900">
                            ...
                            <Link to="/produkty?category=technic">
                                <button className="bg-orange-500 text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-black text-xs md:text-sm uppercase tracking-wide hover:bg-orange-600 transition-all shadow-xl shadow-orange-500/20 flex items-center gap-2 group">
      ...
      <div className="bg-slate-900 text-white py-16 md:py-24 px-4 relative overflow-hidden mt-8">
         ...
         <div className="max-w-3xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center justify-center p-3 bg-slate-800 rounded-2xl mb-6 md:mb-8 shadow-lg">
                <Zap className="text-yellow-400 fill-yellow-400" size={24} />
            </div>
            <h2 className="text-3xl md:text-5xl font-black mb-4 md:mb-6 tracking-tight">Dołącz do Kloc-Express VIP</h2>
            <p className="mb-8 md:mb-10 text-slate-300 text-base md:text-lg leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-lg mx-auto bg-white/5 p-2 rounded-2xl backdrop-blur-sm border border-white/10">
               <input 
                  ...
                  className="flex-1 px-4 md:px-6 py-3 md:py-4 rounded-xl bg-transparent text-white font-medium focus:outline-none placeholder-slate-400 text-center sm:text-left"
               />
               <button className="bg-yellow-400 text-slate-900 font-black px-8 py-3 md:py-4 rounded-xl hover:bg-yellow-300 transition-all shadow-lg active:scale-95 whitespace-nowrap">
                  Odbierz Kod
               </button>
            </div>
         </div>
